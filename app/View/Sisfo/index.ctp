    ...
    <form action="" method="post">
        <table border="1">
            <tr>
                ...
                <td style='width: 20%'>Código: SOP-FOR.009 <hr> Fecha: 03/04/</td>
            </tr>
        </table>
        <div class="input">
        ...
        <div class="input">
            <table>
                ...
                <tr>
                    <td style='width: 25%;'><textarea name="functionality" id="functionality" cols="30" rows="10" style='height: 100px;'></textarea></td>
                    <td style='width: 50%;'><textarea name="description" id="description" cols="30" rows="10" style='height: 100px;'></textarea></td>
                    <td style='width: 25%;'><textarea name="accept" id="accept" cols="30" rows="10" style='height: 100px;'></textarea></td>
                </tr>
            </table>
        </div>
        <div class="input">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style='width: 70%;'>
                        ...
                        <p><input type="text" name="scope_file" id="scope" required placeholder="Ingrese descripción"></p>
                    </td>
                </tr>.
                <tr>
                    ...
                    <td style='width: 70%;'>
                        ...
                        <p><input type="text" name="schedule_file" id="schedule" required placeholder="Ingrese descripción"></p>
                    </td>
                </tr>
            </table>
        </div>
